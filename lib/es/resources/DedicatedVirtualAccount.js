...
export class DedicatedVirtualAccounts {
     ...
     */
    async create(data) {
        return await this.httpClient.post(HttpRequestEndpoints.dedicatedVirtualAccount
     ...
     */
    async list() {
        return await this.httpClient.get(HttpRequestEndpoints.dedicatedVirtualAccount
    ...
    async removeSplit(data) {
        return await this.httpClient.delete(HttpRequestEndpoints.dedicatedVirtualAccount
