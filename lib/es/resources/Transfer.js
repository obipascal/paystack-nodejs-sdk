...
export class Transfer {
     ...
     */
    async initiate(data) {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.initiate, data);
    }
    /**
    ...
    async fetch(id_or_code) {
        return await this.httpClient.get(HttpRequestEndpoints.transfer.fetch.replace(":id_or_code", id_or_code));
    }
    /**
     ...
     */
    async finalize(data) {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.finalize, data);
    }
    /**
     ...
     */
    async bulk(data) {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.bulk, data);
    }
    /**
    ...
    async verify(reference) {
        return await this.httpClient.get(HttpRequestEndpoints.transfer.verify.replace(":reference", reference));
    }
    /**
     * Fetch the available balance on your integration
     */
    async checkBalance() {
        return await this.httpClient.get(HttpRequestEndpoints.transfer.checkBalance);
    }
    /**
    ...
    async resendOtp(data) {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.resendOtp, data);
    }
    /**
     ...
     */
    async disableOtp() {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.disableOtp);
    }
    /**
    ...
    async disableOtpFinalize(data) {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.disableOtpFinalize, data);
    }
    /**
     ...
     */
    async enableOtp() {
        return await this.httpClient.post(HttpRequestEndpoints.transfer.enableOtp);
    }
}
