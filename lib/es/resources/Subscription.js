...
export class Subscription {
     ...
     */
    async create(data) {
        return await this.httpClient.post(HttpRequestEndpoints.subscription.create, data);
    }
    /**
     * List all subscriptions on your integration
     */
    async list() {
        return await this.httpClient.get(HttpRequestEndpoints.subscription.list);
    }
    /**
    ...
    async fetch(id_or_code) {
        return await this.httpClient.get(HttpRequestEndpoints.subscription.fetch.replace(":id_or_code", id_or_code));
    }
    /**
