...
export class Transactions {
    ...
    async initialize(data) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transaction.initialize,
            data
        );
    }
    /**
    ...
    async verify(reference) {
        return await this.httpClient.get(
            HttpRequestEndpoints.transaction.verify.replace(
                ":reference",
                reference
            )
        );
    ...
    async single(id) {
        return await this.httpClient.get(
            HttpRequestEndpoints.transaction.single.replace(":id", id)
        );
    }
    /**
    ...
    async chargeAuthorization(data) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transaction.chargeAuthorization,
            data
        );
    }
    /**
    ...
    async timeline(id_or_reference) {
        return await this.httpClient.get(
            HttpRequestEndpoints.transaction.timeline.replace(
                ":id_or_reference",
                id_or_reference
            )
        );
    ...
    async total() {
        return await this.httpClient.get(
            HttpRequestEndpoints.transaction.total
        );
    }
    /**
    ...
    async export() {
        return await this.httpClient.get(
            HttpRequestEndpoints.transaction.export
        );
    }
    /**
    ...
    async partialDebit(data) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transaction.partialDebit,
            data
        );
    }
}
