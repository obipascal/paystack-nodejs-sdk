...
export declare class Disputes {
     ...
     */
    addEvidence(id: string, data: AddEvidenceBody): Promise<DisputeEvidenceResponse>;
    /**
     * Fetch upload url
     * @param id Dispute ID
     * @param params Upload options
     */
    fetchUploadUrl(id: string, params: GetUploadUrlParams): Promise<DisputeUploadUrlResponse>;
    /**
     * Resolve a dispute
     * @param id Dispute ID
     * @param data Resolution details
     */
    resolve(id: string, data: ResolveDisputeBody): Promise<DisputeResolveResponse>;
    /**
     * Export disputes
     * @param params Filter options
     */
