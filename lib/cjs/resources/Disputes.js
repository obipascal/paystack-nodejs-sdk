...
class Disputes {
     ...
     */
    async list(params) {
        return await this.httpClient.get(request_1.HttpRequestEndpoints.dispute.list, { params });
    }
    /**
     * Fetch a dispute
     * @param id Dispute ID
     ...
     */
    async export(params) {
        return await this.httpClient.get(request_1.HttpRequestEndpoints.dispute.export, { params });
    }
}
