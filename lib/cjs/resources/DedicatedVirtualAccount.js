...
class DedicatedVirtualAccounts {
     ...
     */
    async create(data) {
        return await this.httpClient.post(request_1.HttpRequestEndpoints.dedicatedVirtualAccount.createDedicatedVirtualAccount, data);
    }
    /**
     ...
     */
    async assign(data) {
        return await this.httpClient.post(request_1.HttpRequestEndpoints.dedicatedVirtualAccount.assignDedicatedVirtualAccount, data);
    }
    /**
     * List dedicated virtual accounts available on your integration.
     */
    async list() {
        return await this.httpClient.get(request_1.HttpRequestEndpoints.dedicatedVirtualAccount.listDedicatedVirtualAccount);
    }
    /**
     ...
     */
    async split(data) {
        return await this.httpClient.post(request_1.HttpRequestEndpoints.dedicatedVirtualAccount.splitDedicatedVirtualAccount, data);
    }
    /**
    ...
    async removeSplit(data) {
        return await this.httpClient.delete(request_1.HttpRequestEndpoints.dedicatedVirtualAccount.removeSplitDedicatedVirtualAccount, { data });
    }
    /**
...
exports.default = DedicatedVirtualAccounts;
