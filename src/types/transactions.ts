...
// Response interfaces for Transactions API
...
export declare class Transactions {
    ...
    ): Promise<TransactionChargeAuthorizationResponse>;
    ...
    ): Promise<TransactionPartialDebitResponse>;
}

// Response interfaces for TransactionSplit API
...
export interface TransactionSplitRemoveSubaccountResponse
...
export declare class TransactionSplit {
    ...
    ): Promise<TransactionSplitUpdateResponse>;
    ...
    ): Promise<TransactionSplitAddSubaccountResponse>;
    ...
    ): Promise<TransactionSplitRemoveSubaccountResponse>;
}
