...
export class TransactionSplit {
    ...
    async create(data: TransactionSplitBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transactionSplit.create,
            data
        );
    }
    ...
    async list() {
        return await this.httpClient.get(
            HttpRequestEndpoints.transactionSplit.list
        );
    }
    ...
    async fetch(id: string) {
        return await this.httpClient.get(
            HttpRequestEndpoints.transactionSplit.fetch.replace(":id", id)
        );
    }
    ...
    async update(id: string, data: UpdateSplitTransnactionBody) {
        return await this.httpClient.put(
            HttpRequestEndpoints.transactionSplit.update.replace(":id", id),
            data
        );
    }
    ...
    async addOrUpdateSplitSubaccount(id: string, data: SplitSubaccountBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transactionSplit.addOrUpdateSplitSubaccount.replace(
                ":id",
                id
            ),
            data
     ...
     */
    async removeSplitSubaccount(
        id: string,
        data: RemoveSubaccountFromSplitBody
    ) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transactionSplit.removeSplitSubaccount.replace(
                ":id",
                id
            ),
            data
