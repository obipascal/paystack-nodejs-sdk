...
import {
    BatchRecipientBody,
    TransferRecipientBody,
} from "../types/transferRecipient";
...
export class TransferRecipients {
     ...
     */
    async create(data: TransferRecipientBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transferRecipient.create,
            data
        );
    }
     ...
     */
    async createBulk(data: BatchRecipientBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.transferRecipient.createBulk,
            data
        );
    }
    ...
    async list() {
        return await this.httpClient.get(
            HttpRequestEndpoints.transferRecipient.list
        );
    }
    ...
    async fetch(id_or_code: string) {
        return await this.httpClient.get(
            HttpRequestEndpoints.transferRecipient.fetch.replace(
                ":id_or_code",
                id_or_code
            )
        );
     ...
     */
    async update(id_or_code: string, data: TransferRecipientBody) {
        return await this.httpClient.put(
            HttpRequestEndpoints.transferRecipient.update.replace(
                ":id_or_code",
                id_or_code
            ),
            data
    ...
    async delete(id_or_code: string) {
        return await this.httpClient.delete(
            HttpRequestEndpoints.transferRecipient.delete.replace(
                ":id_or_code",
                id_or_code
            )
        );
