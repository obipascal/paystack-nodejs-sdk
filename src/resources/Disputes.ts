...
export class Disputes {
    ...
    async list(params: DisputeParams) {
        return await this.httpClient.get(HttpRequestEndpoints.dispute.list, {
            params,
        });
    }
    ...
    async fetch(id: string) {
        return await this.httpClient.get(
            HttpRequestEndpoints.dispute.fetch.replace(":id", id)
        );
    }
    ...
    async listTransactionDispute(id: string) {
        return await this.httpClient.get(
            HttpRequestEndpoints.dispute.listTransactionDispute.replace(
                ":id",
                id
            )
        );
    ...
    async update(id: string, data: UpdateDisputeBody) {
        return await this.httpClient.put(
            HttpRequestEndpoints.dispute.update.replace(":id", id),
            data
        );
    }
    ...
    async addEvidence(id: string, data: AddEvidenceBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.dispute.addEvidence.replace(":id", id),
            data
        );
    }
    ...
    async resolve(id: string, data: any) {
        return await this.httpClient.post(
            HttpRequestEndpoints.dispute.resolve.replace(":id", id),
            data
        );
    }
    ...
    async export(params: DisputeParams) {
        return await this.httpClient.get(HttpRequestEndpoints.dispute.export, {
            params,
        });
    }
}
