...
export class Charge {
    ...
    async initialize(data: ChargeBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.initialize,
            data
        );
    }
    ...
    async submitPin(data: SubmitPINBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.submitPin,
            data
        );
    }
    ...
    async submitOtp(data: SubmitOtpBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.submitOtp,
            data
        );
    }
    ...
    async submitPhone(data: SubmitPhoneBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.submitPhone,
            data
        );
    }
    ...
    async submitBirthday(data: SubmitBirthdayBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.submitBirthday,
            data
        );
    }
    ...
    async checkPendingCharge(reference: string) {
        return await this.httpClient.get(
            HttpRequestEndpoints.charge.checkPendingCharge.replace(
                ":reference",
                reference
            )
        );
    ...
    async submitAddress(data: SubmitAddressBody) {
        return await this.httpClient.post(
            HttpRequestEndpoints.charge.submitAddress,
            data
        );
    }
}
